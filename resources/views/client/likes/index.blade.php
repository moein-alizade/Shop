                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($products as $product)
                                <tr>
                                    <td class="text-center"><a href="{{route('client.products.show', $product)}}"><img src="{{str_replace('public', '/storage', $product->image)}}" width="100" alt="{{$product->name}}" title="{{$product->name}}" /></a></td>
