                            ...
                            @foreach($featuredCategory->children as $subCategory)
                                <div id="tab-cat{{$subCategory->id}}" class="tab_content">
                                    <div class="owl-carousel latest_category_tabs">
                                        @foreach($subCategory->allSubCategoryProducts as $product)
                                            <div class="product-thumb">
                                                <div class="image"><a href="{{route('client.products.show', $product->id)}}"><img src="/client/image/product/samsung_tab_1-200x200.jpg" alt="{{$product->name}}" title="{{$product->name}}" class="img-responsive" /></a></div>
                                                <div class="caption">
                                                    <h4><a href="{{route('client.products.show', $product->id)}}">{{$product->name}}</a></h4>
                                                    <p class="price"> <span class="price-new">{{$product->cost}} تومان</span> <span class="price-old">240000 تومان</span> <span class="saving">-5%</span> </p>
                                                    <div class="rating">
